<?php
    class productos_models{
        ...
        public function valida_productos(){
            ...
            $tabla[] = ["id_producto"=>"5", "descripcion"=>"Xiaomi Mi 11 Lite 5G", "costo_compra"=>"$266.99", "precio_venta"=>"$335.99", "cantidad_en_existencia"=>"5", "imagen"=>"https://i02.appmifile.com/489_operator_sg/02/11/2021/93c0a9f30ae6c735f9399fae540cb902.jpg"];
            foreach($tabla as $t)
            {
