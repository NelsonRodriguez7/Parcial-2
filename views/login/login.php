            ...
            <div class="card border-primary mb-3" style="max-width: 20rem;">
                ...
                <form action="<?php echo "index.php?c=".seg::codificar("login")."&m=".seg::codificar("validar") ?>" method="post">
                    ...
                    <div class="text-center">
                        ...
                        <i class="bi bi-facebook"  style="vertical-align: -.300em;"></i>
                        </button>

                        <button type="button" class="btn btn-primary btn-floating mx-1">
                        <i class="bi bi-google" style="vertical-align: -.300em;"></i>
                        </button>

                        <button type="button" class="btn btn-primary btn-floating mx-1">
                        <i class="bi bi-twitter" style="vertical-align: -.300em;"></i>
                        </button>

                        <button type="button" class="btn btn-primary btn-floating mx-1">
                        <i class="bi bi-github" style="vertical-align: -.300em;"></i>
                        </button>
                    </div>
                    </form>
                </div>
